...
class ProfesorForm(ModelForm):
	class Meta:
		...
		widgets = {
			'RUTprof' : forms.TextInput(attrs={'class' : 'forms-control','placeholder': 'Con Punto & Guion'}),
			'NombreProf' : forms.TextInput(attrs={'class' : 'forms-control','placeholder': 'Primer Nombre & Apellidos'}), 
			'GeneroProf': forms.Select(attrs={'class' : 'forms-control'}),
			'LocalPerteneciente' : forms.Select(attrs={'class' : 'forms-control'}), 
